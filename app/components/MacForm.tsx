...
export default function MacForm() {
 ...
 <div className="p-1.5 bg-indigo-50 /30 rounded-lg text-indigo-600 ">
 <Info size={18} />
 </div>
 ...
 className={`bg-transparent border-none p-0 text-[10px] font-bold text-indigo-500 uppercase tracking-wider outline-none w-full placeholder:text-zinc-300 cursor-pointer ${editingField === 'name' ? 'ring-1 ring-indigo-500/30 rounded px-1' : ''}`}
 />
 </div>
 </div>
 <input
 ...
 maxLength={12}
 className={`w-full bg-zinc-50 /50 border border-zinc-200 /50 rounded-lg px-3 py-2 text-sm font-mono focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all text-zinc-800 cursor-pointer ${editingField === 'full' ? 'bg-white border-indigo-500' : ''}`}
 />
 </div>
 ...
 className={`w-8 h-8 bg-zinc-50 /50 border border-zinc-200 /50 rounded-md text-center text-xs font-mono focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all text-zinc-800 p-0 cursor-pointer ${editingField === i ? 'bg-white border-indigo-500' : ''}`}
 />
