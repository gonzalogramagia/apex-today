...
export default function ImportModal({ lang }: ImportModalProps) {
    ...
    const t = {
        ...
        countdown: isEnglish ? 'Countdown' : 'Cuentas regresivas',
            ...
            <div className="bg-white w-full max-w-md rounded-xl shadow-2xl border border-zinc-200 flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div
                        ...
                        className={`border-2 border-dashed rounded-xl p-8 flex flex-col items-center justify-center text-center cursor-pointer transition-colors ${file ? 'border-[#6866D6] bg-[#6866D6]/5 [#6866D6]/20' : 'border-zinc-300 hover:border-zinc-400 '
                            }`}
                    >
                        <input
                            ref={fileInputRef}
                    ...
                    {error && (
                        <div className="flex items-center gap-2 text-red-500 text-sm bg-red-50 /20 p-3 rounded-lg">
                ...
                {/* Footer */}
                <div className="p-4 border-t border-zinc-100 flex justify-end gap-3 bg-zinc-50/50 /50">
                    <Link
                        href="/"
