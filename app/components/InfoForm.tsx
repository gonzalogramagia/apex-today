...
export default function InfoForm() {
 ...
 const CopiedMessage = () => (
 <span className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1.5 text-[10px] font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded-md border border-green-200 shadow-sm animate-in fade-in zoom-in duration-200">
 ...
 {/* Info Card */}
 <div className="bg-white border border-zinc-200 rounded-xl shadow-xl p-5 backdrop-blur-sm bg-white/90 /90 hover:shadow-indigo-500/10 transition-shadow">
 ...
 <button
 onClick={handleCopy}
 className="p-1.5 rounded-md hover:bg-zinc-100 text-zinc-500 transition-colors cursor-pointer group relative"
 ...
 <button
 onClick={handleClear}
 className="p-1.5 rounded-md hover:bg-red-50 /20 text-zinc-400 hover:text-red-500 transition-colors cursor-pointer"
 ...
 <label className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider flex-shrink-0">
 ...
 className={`w-full rounded-lg px-3 py-2 text-sm font-mono outline-none transition-all text-zinc-800 cursor-pointer 
 ${editingField === 'clientName'
 ? 'bg-white border-2 border-indigo-500 ring-4 ring-indigo-500/10 shadow-lg scale-[1.02]'
 : `bg-zinc-50 /50 border border-zinc-200 /50 ${copiedField === 'clientName' ? 'border-green-500 text-green-600 ' : 'hover:border-indigo-300 /50'}`
 }`}
 />
 ...
 className={`bg-transparent border border-transparent p-0 text-[10px] font-bold text-indigo-500 uppercase tracking-wider outline-none w-full placeholder:text-zinc-300 cursor-pointer transition-all rounded px-1
 ${editingField === 'ticketingSystem'
 ? 'bg-white ring-2 ring-indigo-500/20 shadow-sm border-transparent'
 : `hover:bg-indigo-50 /10 ${copiedField === 'ticketingSystem' ? 'border-green-500 text-green-600 ' : ''}`}`
 }
 />
 {copiedField === 'ticketingSystem' && (
 <span className="absolute right-0 top-1/2 -translate-y-1/2 flex items-center gap-1 text-[9px] font-bold text-green-600 bg-white px-1.5 py-0.5 rounded shadow-sm border border-green-100 /50">
 {isEnglish ? 'Copied!' : 'Copiado!'}
 ...
 ? 'bg-white border-2 border-indigo-500 ring-4 ring-indigo-500/10 shadow-lg scale-[1.02]'
 : `bg-zinc-50 /50 border border-zinc-200 /50 ${copiedField === 'ticketId' ? 'border-green-500 text-green-600 ' : 'hover:border-indigo-300 /50'}`
 }`}
 />
 ...
 ${editingField === 'cuit'
 ? 'bg-white border-2 border-indigo-500 ring-4 ring-indigo-500/10 shadow-lg scale-[1.02]'
 : `bg-zinc-50 /50 border border-zinc-200 /50 ${copiedField === 'cuit' ? 'border-green-500 text-green-600 ' : 'hover:border-indigo-300 /50'}`
 }`}
 />
 {copiedField === 'cuit' && (
 <span className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1.5 text-[10px] font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded-md border border-green-200 shadow-sm animate-in fade-in zoom-in duration-200">
 ...
 ? 'bg-white border-2 border-indigo-500 ring-4 ring-indigo-500/10 shadow-lg scale-[1.02]'
 : `bg-zinc-50 /50 border border-zinc-200 /50 ${copiedField === 'address' ? 'border-green-500 text-green-600 ' : 'hover:border-indigo-300 /50'}`
 }`}
 />
 {copiedField === 'address' && (
 <span className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1.5 text-[10px] font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded-md border border-green-200 shadow-sm animate-in fade-in zoom-in duration-200">
 ...
 ? 'bg-white border-2 border-indigo-500 ring-4 ring-indigo-500/10 shadow-lg scale-[1.02]'
 : `bg-zinc-50 /50 border border-zinc-200 /50 ${copiedField === 'productId' ? 'border-green-500 text-green-600 ' : 'hover:border-indigo-300 /50'}`
 }`}
 />
 ...
 ${editingField === 'name'
 ? 'bg-white ring-2 ring-indigo-500/20 shadow-sm border-transparent'
 : `hover:bg-indigo-50 /10 ${copiedField === 'name' ? 'border-green-500 text-green-600 ' : ''}`}`
 }
 />
 {copiedField === 'name' && (
 <span className="absolute right-0 top-1/2 -translate-y-1/2 flex items-center gap-1 text-[9px] font-bold text-green-600 bg-white px-1.5 py-0.5 rounded shadow-sm border border-green-100 /50">
 ...
 ${editingField === 'full'
 ? 'bg-white border-2 border-indigo-500 ring-4 ring-indigo-500/10 shadow-lg scale-[1.02]'
 : `bg-zinc-50 /50 border border-zinc-200 /50 ${copiedField === 'full' ? 'border-green-500 text-green-600 ' : 'hover:border-indigo-300 /50'}`
 }`}
 />
 ...
 className={`w-8 h-8 rounded-md text-center text-xs font-mono outline-none transition-all text-zinc-800 p-0 cursor-pointer 
 ${editingField === i
 ? 'bg-white border-2 border-indigo-500 ring-4 ring-indigo-500/10 shadow-lg scale-110 z-10'
 : `bg-zinc-50 /50 border border-zinc-200 /50 ${copiedField === 'parts' ? 'border-green-500 text-green-600 scale-105' : 'hover:border-indigo-300 /50'}`
 }`}
 />
 {copiedField === 'parts' && (
 <div className="absolute inset-0 flex items-center justify-center bg-white border border-green-300 rounded-md text-green-600 font-bold z-20 pointer-events-none animate-in zoom-in-50 duration-200 scale-105 shadow-sm">
 {['C', 'O', 'P', 'I', 'E', 'D'][i]}
 </div>
 )}
 </div>
 {i < 5 && <span className="text-zinc-400 font-medium">:</span>}
 </div>
 ))}
 </div>
