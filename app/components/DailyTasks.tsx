...
export default function DailyTasks() {
 ...
 className="rounded px-1.5 py-1 transition-colors cursor-pointer bg-zinc-200 text-zinc-500 hover:bg-red-100 hover:text-red-500 /20 mr-[1px]"
 >
 <X size={14} />
 </button>
 </div>
 ...
 className="rounded p-1.5 transition-colors cursor-pointer bg-zinc-200 text-zinc-500 hover:bg-red-100 hover:text-red-500 /20 mr-[1px]"
 >
 <X size={14} />
 </button>
 </div>
