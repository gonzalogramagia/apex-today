	...
	return (
		<>
			...
			<div className="fixed bottom-8 right-8 flex gap-3 z-[70]">
				...
				>
					<Zap className="w-6 h-6 text-zinc-900 group-hover:text-yellow-500 transition-colors" />
				</a>
			</div>
			...
			<div className="fixed bottom-8 left-8 flex gap-3 z-50">
				...
				<div
					className="p-3 bg-white border border-zinc-200 rounded-full shadow-sm opacity-50 cursor-not-allowed group"
					aria-label="Hoy"
				>
					<ClipboardClock className="w-6 h-6 text-zinc-900 " />
				</div>
				...
				<a
					...
					aria-label="Emojis"
				>
					<Smile className="w-6 h-6 text-zinc-900 group-hover:text-yellow-500 transition-colors" />
				</a>
				{/* 3 - Botón Expansible (Ej. Apex Search) - Fíjate en la clase 'peer' */}
				<a
					href={lang === 'en' ? 'https://apexsearch.vercel.app/en' : 'https://apexsearch.vercel.app'}
					className="peer group flex items-center p-3 bg-white border border-zinc-200 rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110 cursor-pointer"
					aria-label="Apex Search"
				>
					<BookCheck className="w-6 h-6 shrink-0 text-zinc-900 group-hover:text-yellow-500 transition-colors" />
					...
					<span className="text-sm font-semibold max-w-0 opacity-0 overflow-hidden whitespace-nowrap transition-all duration-300 ease-in-out group-hover:max-w-[150px] group-hover:opacity-100 group-hover:ml-2 group-hover:text-yellow-500">
						{lang === 'en' ? 'Go to Apex Search' : 'Ir a Apex Search'}
					</span>
				</a>
				...
				<a
					...
					aria-label="Antipala"
				>
					<Shovel className="w-6 h-6 text-zinc-900 group-hover:text-yellow-500 transition-colors" />
				</a>
			</div>
		</>
	);
