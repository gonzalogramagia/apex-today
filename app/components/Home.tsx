...
export default function Home({ lang }: HomeProps) {
 ...
 tag: makeId(),
 title: "",
 content: lang === 'en' ? "Example: My first note" : "Nota de Ejemplo",
 color: "#FEFCE8",
 }]);
 } else {
 ...
 className="text-gray-400 hover:text-[#6866D6] transition-colors cursor-pointer disabled:opacity-30 disabled:cursor-default p-1 bg-white/50 /20 rounded shadow-sm hover:shadow transition-all border border-black/5"
